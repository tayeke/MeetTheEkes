    ...
    icons = [
        {
            ...
            <div class="center-text">
                ...
                <p><a href="https://secureapps.wsdot.wa.gov/ferries/reservations/Vehicle/SailingSchedule.aspx" target="_blank">Washington State Ferry Reservations</a></p>
            </div>
            `,
  ...
  $(function() {
    ...
    map.addListener("click", function(event) {
        for (var i = 0; i < icons.length; i++ ) {
            if(typeof icons[i].infoWindow !== 'undefined') {
                icons[i].infoWindow.close();
            }
        }
    });
    ...
    function openMarker(icon) {
      if(typeof icon.infoWindow === 'undefined') {
      ...
      icon.infoWindow.open(map, icon.marker);
    }
    ...
    for(var i = 0; i < icons.length; i++) {
      ...
      icons[i].marker.addListener('click', openMarker.bind(null, icons[i]));
    }
